function saveTextAsFile() {
    ...
    let tdollProxies = ["Andoris", "Bathilde", "Colphne", "Helia", "Krolik", "Lotta", "Nemesis", "Peritya", "Sharkry", "Ullrid", "Vepley", "Zhaohui"];
