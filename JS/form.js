function saveTextAsFile() {
    ...
    let nikkeProxies = ["Ade", "Blanc", "Brid", "Cinderella", "Crow", "D", "Diesel", "Dorothy", "Emma", "Ether", "Frima", "Guilty", "Harran", "Helm", "Isabel", "Maiden", "Marian", "Mast", "Mihara", "Milk", "Modernia", "Nero", "Neve", "Privaty", "Rapi", "Rapunzel", "Rosanna", "Soda", "Sugar", "Volume", "Yuni"];
