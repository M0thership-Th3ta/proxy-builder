function saveTextAsFile() {
    ...
    let vtuberProxies = ["Akami Hebiko", "Akiko Sushi", "Alias Anono", "Anime4days", "Annytf", "Arialyxiah", "Aruna Reaver", "Attera Nox", "August Anomaly", "Babocloud", "Beribug", "Beyumi_", "BibblyDarling", "Bomie", "BrittyWho", "Brujita", "Buffpup", "CalicoDia", "Callie Calico", "Camila MYTHICS", "Captain Hannah", "Ceelio_ch", "Chongusdongus", "ChonkyLotus", "Chu Senpai", "Ciirilla", "Clotho MYTHOS", "Coni Confetti", "Coqui", "CrysaliaVT", "Daiya Fortuna", "Daph MYTHICS", "Daph_VT", "Daphne Duck", "Dearallyse", "Dee the Sphynx", "Dreammxyy", "Eden Vtuber", "EliaStellaria", "Elorapard", "EmeikoVT", "Eoisvt", "Euna Miku", "FangzAH", "Fenari Mori", "FifiGoesRee", "Fluffenfox", "Fream", "FufuVT", "Furi Ferntail", "FuwaCH", "GammaInkk", "GirlDM", "Gyarugoyle", "HanichuuVT", "Hikanari Hina", "HuntressSpectre", "Iluvei", "Jean Faymas", "JellySaora", "Jowol (PorcelainMaid)", "K1ttch3n", "Kairuui", "Kilia Kurayami", "KiranaYonome", "KonoobiVtuber", "KumoGoroGoro", "Larryybearr", "LavandereVT", "Lealumie", "Lewnabun", "LoLotus", "Lorelai Loch", "Lylanxia", "LyraCalyptra", "Mae Dawn", "Meatscave", "Milla Noire", "Millie Meraki", "Mina Aoyama", "MinikoMew", "MiquellaVT", "Mirune Mochi", "Miyune", "Moegi Lida", "Momotexx", "Mono Monet", "Moomochi", "MoonbunVT", "Mozumi Pichi", "Murdercrumpet", "NaiyoSpede", "Nako Moon", "Nanamine Nina", "NEBULAHNEI", "NekomancerVT", "NyaNeila", "Olivia Monroe", "OniGiri", "Onikanzei", "OrendaVT", "Para Norma", "PeikuVT", "PinBunVT", "Pinkchyu", "Pippin Otter", "Piranya", "PixCatOS", "PolarPeri", "Puresera_", "QueensWrath", "Rae Chuu", "RamuneLive", "Rana Ianna", "Ray Himesama", "Reina Sun", "Remilia", "Remuchii", "Reycall", "Rin Penrose", "RivaVTuber", "Roca Rourin", "Saeko Kitsune", "SakurahVT", "Savisenpai", "Scarlett Flameheart", "Secret Subject", "Seira Wynn", "Shekai", "Shisui Michiru", "Shoozki", "Silva livv", "SimplyAzura", "SpongeyBuns", "Star2d2", "Succuguts", "Sukovt", "Sylliah", "SylveeVT", "Techycutie", "Thor Chan VR", "ttvrosie", "Vaempy", "Vexoria", "VitaMyon", "Whiskey Project", "Whoisrinkya", "Yae Yugiri", "YFU Baby", "Yomi Quinnley", "YourItalianWaifu", "YuikaiChan", "Yura Rikudou", "YUY IX", "Zeus MYTHOS", "Hermes MYTHOS", "Dionysus MYTHOS", "Hephaestus MYTHOS", "MyuVT"];
